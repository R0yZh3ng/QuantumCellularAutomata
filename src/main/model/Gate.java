...
// this class will contain all the predetermined gates(operations/static matrices that will be operated with the Qubits) in a 2 x 2 format.
...
public class Gate {
    ...
    public ComplexNumber multiplyMatrix(Gate gate){
        return new ComplexNumber(1, 0); // stub
    }

    // hadamard gate introduces a superposition state for the Qubit (when there is a equal probability of both the real and imaginary number)
    ...
    // flips the numbers while introducing a phase shift of the imaginary
    public static final Gate XPHASEFLIP = new Gate(new ComplexNumber[][]{
